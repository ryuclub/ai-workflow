...
| 规约 | [`.claude/guidelines/`](./.claude/guidelines/) | Mosavi 编码 / 分支 / JIRA / 提交前自审 / 测试规格（各产品仓可裁剪） |
...
- **内容是 Mosavi 风味**（`jira_api`、`MOS-` 工单、Mosavi-docs 链接、Mosavi 规约）。沿用于其他 Mosavi 仓即可；用于非 Mosavi 项目需替换 `guidelines/` 与 JIRA 配置。
